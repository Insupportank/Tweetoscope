 ...
 *
 */
public class EmptyTweetFilter3 extends TweetFilter3 {
	
	public static void main(String[] args) {
		new EmptyTweetFilter3(args[0], args[1], args[2]);
	}
	
	public EmptyTweetFilter3(String bootstrapServers, String inputTopicName, String outputTopicName) {
