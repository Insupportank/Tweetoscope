 ...
 *
 */
public class CountryCodeTweetFilter2 extends OnlineTweetFilter {
	 ...
	 */
	public CountryCodeTweetFilter2(String countryCode) {
...
/*				SingleTweetLookupResponse response = twitterApiInstance.tweets().findTweetById(tweet.getId(),
				...
				APIfindTweetByIdRequest request = twitterApiInstance.tweets().findTweetById(tweet.getId());
				
				Get2TweetsIdResponse response = request.execute();
